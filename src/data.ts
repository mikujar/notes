...
export const collections: Collection[] = [
  {
        ...
        cards: [
          {
            id: "n-morning",
            minutesOfDay: t(7, 30),
            text: "【示例子合集】「晨间」挂在「示例 · 一天怎么记」下面。子合集里的卡片与顶级合集一样，只是多了一层归类。\n可用来分：工作 / 生活、项目 A / 项目 B。",
          },
        ],
      },
      {
    ...
    cards: [
      ...
      },
      {
        ...
        relatedRefs: [{ colId: "c1", cardId: "n3" }],
      },
      {
        id: "n3",
        minutesOfDay: t(1, 52),
        text: "【示例 · 会议】14:00 站会\n- 风险：依赖方未回确认\n- 负责人：@小陈 今天下班前跟进\n\n会后可以把结论拆成多条，分别记在不同时刻。",
        tags: ["测试", "学习"],
        relatedRefs: [{ colId: "c1", cardId: "n2" }],
      },
      {
        id: "n4",
        minutesOfDay: t(9, 15),
